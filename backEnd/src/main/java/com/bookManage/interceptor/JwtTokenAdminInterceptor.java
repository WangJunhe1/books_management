...
import com.bookManage.exception.TokenNotExitException;
...
public class JwtTokenAdminInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(token == null){
            ...
            throw new TokenNotExitException(MessageConstant.USER_NOT_LOGIN);
        }
        ...
        try {
            ...
            //4、不通过，响应401状态码
            response.setStatus(401);
            throw new TokenNotExitException(MessageConstant.TOKEN_INVALID);
        }
    }
}
